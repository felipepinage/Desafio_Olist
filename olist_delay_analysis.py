...
corr = abs(corr)
feat_imp = corr['most_voted_class'].nlargest(corr['most_voted_class'].count()) #most important feature to less important when delivery delayed
...
# PLOT NUMBER OF DELAYS VS CLASSES
class_names = ['Delivery Problem', 'Quality Problem', 'Satisfied']
plt.figure()
pe, pq, sat = plt.bar(class_names, total_delays_perc)
pe.set_facecolor('r')
pq.set_facecolor('g')
sat.set_facecolor('b')
plt.xlabel('Classes')
...
# PLOT REVIEWS BEFORE/AFTER DELIVERY (IN DELAY)
plt.figure()
plt.pie([perc_rbd_delay, perc_rad_delay], labels=['Before Delivery', 'After Delivery'], autopct='%1.1f%%',
        shadow = True, startangle = 90)
plt.title('REVIEWS (DELAYED DELIVERY)')
...
# PLOT DELAYED DELIVERY - NUMBER OF REVIEWS BEFORE DELIVERY
plt.figure()
pe, pq, sat = plt.bar(class_names, perc_rbd_delay_class)
pe.set_facecolor('y')
pq.set_facecolor('m')
sat.set_facecolor('c')
plt.xlabel('Classes')
plt.ylabel('Percentage')
plt.title('DELAYED DELIVERY - NUMBER OF REVIEWS BEFORE DELIVERY')
...
# PLOT DELAYED DELIVERY - NUMBER OF REVIEWS AFTER DELIVERY
plt.figure()
pe, pq, sat = plt.bar(class_names, perc_rbd_delay_class)
pe.set_facecolor('y')
pq.set_facecolor('m')
...
plt.xlabel('Classes')
plt.ylabel('Percentage')
plt.title('DELAYED DELIVERY - NUMBER OF REVIEWS AFTER DELIVERY')
